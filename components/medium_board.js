...
export const MediumBoard = () => {
  return (
    <div className="ml-10 grid grid-cols-12 gap-2 text-center relative">
      <div className="flex flex-col justify-center items-center bg-gradient-to-b from-yellow-100 to-yellow-400 rounded-lg px-6 py-6">
        <h1 className="">50</h1>
      ...
      <div className="flex flex-col justify-center items-center bg-gradient-to-b from-green-100 to-green-400 rounded-lg px-6 py-6">
        <h1 className="">46</h1>
      ...
      <div className="absolute bottom-[78px] right-[135px]">
        <svg
          width="80"
          height="80"
          viewBox="0 0 24 24"
      ...
      {/* <Image
        ...
        width={43}
        height={100}
        className="absolute bottom-[98px] right-[152px]"
        quality={90}
      /> */}
      {/* Tile 20 Go to Tile 26 */}
      <div className="absolute bottom-[275px] left-[285px]">
        <svg
          width="80"
          height="80"
          viewBox="0 0 24 24"
      ...
      {/* <Image
        ...
        width={43}
        height={150}
        className="absolute bottom-[255px] left-[250px] -rotate-[55deg] brightness-50"
        quality={90}
      />
      <Image
        src={'/images/ladder.png'}
        width={43}
        height={150}
        className="absolute bottom-[316px] left-[162px] -rotate-[55deg] brightness-50"
        quality={90}
      />
      <Image
        src={'/images/ladder.png'}
        width={43}
        height={150}
        className="absolute bottom-[377px] left-[74px] -rotate-[55deg] brightness-50"
        quality={90}
      /> */}
      ...
      /> */}
      {/* Tile 33 to 37 */}
      <div className="absolute bottom-[475px] right-[280px]">
        <svg
          width="80"
          height="80"
          viewBox="0 0 24 24"
